class Admin::EventsController < ApplicationController
  ...
  def event_params
    params.require(:event).permit(
      ...
      :starts_at, :price, :facebook_url, :website, :is_active,
      :has_lessons, :lessons_time, :latitude, :longitude,
      :level, :organizer_name, :organizer_email, :phone,
      :is_free, :recurrence, :postal_code,
      dance_styles: []
    )
  end
end
